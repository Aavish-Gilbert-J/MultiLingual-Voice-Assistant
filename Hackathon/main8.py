...
"\n"
"#pushButton_4{background-color:rgba(0, 175, 250, 1);border-radius:30}\n"
"\n"
"#pushButton_4:hover{background-color:rgba(0, 175, 250, 0.5);border-radius:30}\n"
"\n"
...
#this is a function to deal with buttons in the gui
...
#this is called when the input language button is clicked
...
#this is called when the output language button is clicked                
    ...
    def record(self):
        ...
        for i in dicti:
                    if i in dicti:
                        ...
                        #print(keyword_extracted[0])
                  
                        f=str(wikipedia.summary(keyword_extracted,sentences=1))
                        raw=f.lower()
                        print(f)
    ...
    def question(self):
        ...
        with sr.Microphone() as source:
                ...
                try:
                    langtext = r.recognize_google(audio_data,language=dicti[o])
                    print("You said:",langtext)
