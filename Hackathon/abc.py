...
".QLabel{color:White;}\n"
"#pushButton{background-color:rgba(255,255,255, 1);border-radius:30}\n"
"\n"
"#pushButton:hover{background-color:rgba(255,255,255, 0.5);border-radius:30}\n"
"\n"
"#pushButton_2{background-color:rgba(255,255,255, 1);border-radius:20;}\n"
"\n"
"#pushButton_2:hover{background-color:rgba(255,255,255, 0.5);border-radius:30}\n"
"\n"
"#pushButton_3{background-color:rgba(255,255,255, 1);border-radius:20;}\n"
"\n"
"#pushButton_3:hover{background-color:rgba(255,255,255, 0.5);border-radius:30}\n"
"\n"
"#pushButton_4{background-color:rgba(255,255,255, 1);border-radius:30}\n"
"\n"
"#pushButton_4:hover{background-color:rgba(255,255,255, 0.5);border-radius:30}\n"
"\n"
"#pushButton_5{background-color:rgba(255,255,255, 1);border-radius:30}\n"
"\n"
"#pushButton_5:hover{background-color:rgba(255,255,255, 0.5);border-radius:30}\n"
"\n"
...
".comboBox{color:red}")
        ...
        self.pushButton.setGeometry(QtCore.QRect(490, 580, 121, 51))
        icon = QtGui.QIcon()
        ...
        self.pushButton_4.setGeometry(QtCore.QRect(430, 640, 231, 51))
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap(":/icons/feather/square.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.pushButton_4.clicked.connect(self.question)
        self.pushButton_5.clicked.connect(self.pdf)
        self.pushButton_5.setText(_translate("MainWindow", "UPLOAD FILE"))
        self.pushButton_4.setText(_translate("MainWindow", "Question"))
    ...
    def pdf(self):
        ...
        if check:
                ...
                # for i in range(0,10):
                #     translation = GoogleTranslator(source='en', target=dicti[o].upper()).translate(l1[i])
    ...
    def record(self):
        ...
        for i in dicti:
                    if i in dicti:
                        ...
                        try:
                            f=str(wikipedia.summary(ip,sentences=50))
                            raw=f.lower()
                            print(f)
                            
                            s=s+"\nBot:Ask any question about "+ip
                        ...
                        # tts = gTTS(translation, lang=dic[o],tld='co.in', slow=False )
                        # tts.save('hello.mp3')
